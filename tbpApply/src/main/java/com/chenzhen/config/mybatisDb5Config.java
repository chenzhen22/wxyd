...
@Configuration
@MapperScan(basePackages = {"com.chenzhen.mapper.sitcbsMapper"}, sqlSessionFactoryRef = "sqlSessionFactory5")
public class mybatisDb5Config {

	@Value("${mybatis.sitcbsMapper}")
	...
	public SqlSessionTemplate sqlSessionTemplate5() throws Exception {
		SqlSessionTemplate template = new SqlSessionTemplate(sqlSessionFactory5());
		return template;
	}
}
