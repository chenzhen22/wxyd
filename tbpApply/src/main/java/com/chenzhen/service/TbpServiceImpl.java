...
public class TbpServiceImpl implements TbpService {
    ...
    public String docQry(String docname) {
        ...
        Workbook workBook = null;
        workBook = getExcelTemplate(templatePath, templateName);
        setStyle(workBook);
        ...
        String npath = saveExcel(workBook, templatePath, docname, project);
...
*/
    ...
    public void uploadDocumentFile(DocumentFile docFile) {
        String userName = userService.getUserName(docFile.getClientIp());
    ...
    public String docQryAll(String type) {
        ...
        if (doc != null) {
            ...
            String filePath = "/apps/data/wxyd/doc/" + fileName;
            return filePath;
        }
